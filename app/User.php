...
class User extends Authenticatable
{
    ...
    protected $fillable = ['id', 'name', 'repertory_id', 'nick_name', 'password', 'telephone', 'wx_number', 'address', 'creater_id', 'status', 'created_at',  'remark'];
    ...
    public function hasManyCreaterRepertory() {

        return $this->hasMany('App\Repertory', 'creater_id', 'id');
    }
